...
slug: /go/v2-Authentication-RemovePrivilegesFromGroup
sidebar_label: "RemovePrivilegesFromGroup()"
beta: FALSE
notebook: FALSE
description: "This operation removes the specified privileges from a privilege group. | Go | v2"
type: origin
token: K8b0wFqy9ibkLFkuhq0cqDrRnMh
sidebar_position: 16
...
<table>
   ...
   <tr>
     ...
     <td><p>The privileges to add into the above group.</p><p>For details, refer to .</p></td>
     <td><p><code>...string</code></p></td>
   </tr>
</table>
