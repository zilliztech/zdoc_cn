...
<table>
    ...
    <tr>
        ...
        <td>Consistency level used in the search. If the level is not set, will use the default consistency level of the collection.</td>
...
<table>
   ...
   <tr>
     <td>getIDScore(int indexOfTarget)<br/></td>
