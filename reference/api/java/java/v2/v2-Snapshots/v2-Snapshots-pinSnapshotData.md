...
sidebar_key: java/v2-Snapshots-pinSnapshotData
...
beta: false
notebook: false
description: "This operation pins snapshot data for a limited time so it is not garbage-collected while being copied or inspected. | Java | v2"
type: docx
