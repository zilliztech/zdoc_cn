...
<RestHeader method="post" endpoint="https://controller.api.${CLOUD_REGION}.zilliz.com.cn/v1/clusters/{CLUSTER_ID}/suspend" />
...
```shell
curl --request POST \ 
     --url "https://controller.${CLOUD_REGION}.cloud.zilliz.com.cn/v1/clusters/<Cluster-ID>/suspend" \
