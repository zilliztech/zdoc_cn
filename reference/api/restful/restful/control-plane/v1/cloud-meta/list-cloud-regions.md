...
<RestHeader method="get" endpoint="https://controller.api.${CLOUD_REGION}.zilliz.com.cn/v1/regions" />
...
```shell
curl --request GET \
     --url "https://controller.api.${CLOUD_REGION}.cloud.zilliz.com.cn/v1/regions?cloudId=ali" \
