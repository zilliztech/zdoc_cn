...
<RestHeader method="post" endpoint="https://controller.api.${CLOUD_REGION}.zilliz.com.cn/v1/vector/collections/import" />
...
```shell
curl --request POST \
     --url "https://controller.api.${CLOUD_REGION}.cloud.zilliz.com.cn/v1/vector/collections/import" \
