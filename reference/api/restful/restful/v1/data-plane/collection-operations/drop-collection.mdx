...
beta: NEAR DEPRECATE
title: "删除 Collection (V1) | RESTful"
description: "本接口用于删除 Collection。删除 Collection 将会清空 Collection 中的所有数据。请谨慎操作。 | RESTful"
hide_table_of_contents: true
sidebar_label: "删除 Collection (V1)"
