...
beta: FALSE
title: "Grant Role To User (V2) | RESTful"
description: "This operation grants a specified role to the current user. Once granted the role, the user gets permissions allowed for the current role and can perform certain operations. | RESTful"
hide_table_of_contents: true
sidebar_label: "Grant Role To User (V2)"
