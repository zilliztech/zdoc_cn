...
title: "授予用户角色 | restful"
description: "本接口可以为指定用户分配指定角色。角色授予完成后，用户将获得当前角色所允许的权限，并可以执行相应的操作。 | restful"
hide_table_of_contents: true
sidebar_label: "授予用户角色"
