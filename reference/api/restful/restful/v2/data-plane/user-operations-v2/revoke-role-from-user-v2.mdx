...
beta: FALSE
title: "撤销用户角色 (V2) | RESTful"
description: "本接口撤销已授予指定用户的权限。 | RESTful"
hide_table_of_contents: true
sidebar_label: "撤销用户角色 (V2)"
