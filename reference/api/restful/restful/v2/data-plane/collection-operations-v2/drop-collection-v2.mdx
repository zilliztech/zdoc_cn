...
beta: FALSE
title: "删除 Collection (V2) | RESTful"
description: "本接口可删除指定 Collection 及存放其中的所有数据。 | RESTful"
hide_table_of_contents: true
sidebar_label: "删除 Collection (V2)"
