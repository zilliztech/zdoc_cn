...
beta: FALSE
title: "查看 Collection 是否存在 (V2) | RESTful"
description: "本接口可检查指定的 Collection 是否存在。 | RESTful"
hide_table_of_contents: true
sidebar_label: "查看 Collection 是否存在 (V2)"
sidebar_custom_props: { badges: ['post']}
---

# 查看 Collection 是否存在 (V2)
