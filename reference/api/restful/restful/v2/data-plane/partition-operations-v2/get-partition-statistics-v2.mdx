...
beta: FALSE
title: "查看 Partition 统计信息 (V2) | RESTful"
description: "本接口可以查看指定 Partition 中存放的 Entity 数量。 | RESTful"
hide_table_of_contents: true
sidebar_label: "查看 Partition 统计信息 (V2)"
sidebar_custom_props: { badges: ['post']}
---

# 查看 Partition 统计信息 (V2)
