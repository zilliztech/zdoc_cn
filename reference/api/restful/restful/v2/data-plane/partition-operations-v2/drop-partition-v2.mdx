...
title: "删除 Partition | RESTful"
description: "本接口可以删除指定 Partition. 在删除 Partition 前，请确保该 Partition 已经从内存中释放。你可以使用[释放 Partition](/reference/restful/release-partitions-v2) 接口释放该 Partition。 | RESTful"
hide_table_of_contents: true
sidebar_label: "删除 Partition"
