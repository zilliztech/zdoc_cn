...
beta: FALSE
title: "创建 Partition (V2) | RESTful"
description: "本接口用于在 Collection 中创建 Partition。 | RESTful"
hide_table_of_contents: true
sidebar_label: "创建 Partition (V2)"
