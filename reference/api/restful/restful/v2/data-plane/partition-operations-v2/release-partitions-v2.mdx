...
beta: FALSE
title: "释放 Partition (V2) | RESTful"
description: "本接口从内存中释放指定 Partition 数据。 | RESTful"
hide_table_of_contents: true
sidebar_label: "释放 Partition (V2)"
