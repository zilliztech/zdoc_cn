...
This operation in [VoyageRerankFunction](./Rerankers-VoyageRerankFunction) takes in a query and document strings and returns a list of `RerankResult` objects with the top k documents ranked by score.
