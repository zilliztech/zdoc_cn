...
This operation in [CohereEmbeddingFunction](./EmbeddingModels-CohereEmbeddingFunction) takes a list of text strings and directly encodes them into vector embeddings.
