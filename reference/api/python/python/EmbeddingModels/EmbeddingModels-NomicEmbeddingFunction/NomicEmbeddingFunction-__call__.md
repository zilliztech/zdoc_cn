...
This operation in [NomicEmbeddingFunction](./EmbeddingModels-NomicEmbeddingFunction) takes a list of text strings and directly encodes them into vector embeddings.
