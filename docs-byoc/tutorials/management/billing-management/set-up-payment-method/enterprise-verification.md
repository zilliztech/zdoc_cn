...
notebook: FALSE
description: "Zilliz Cloud 现已开通企业认证渠道。如需进行现金充值，您需要先通过企业认证。本章主要介绍如何在 Zilliz Cloud 界面上申请企业认证。 | BYOC"
type: origin
...
Zilliz Cloud 现已开通企业认证渠道。如需进行[现金充值](./cash-recharge)，您需要先通过企业认证。本章主要介绍如何在 Zilliz Cloud 界面上申请企业认证。
