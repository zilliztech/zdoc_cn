...
notebook: FALSE
description: "StructArray 支持范围涵盖 Schema 定义、insert payload、Index、Search mode，以及 StructArray 专用 Filter。在生产中依赖 StructArray 行为前，请使用本文作为限制参考。 | BYOC"
type: origin
