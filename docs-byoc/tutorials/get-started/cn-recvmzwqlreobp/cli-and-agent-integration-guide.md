---
title: "快速开始：安装 CLI 与 Agent 集成 | BYOC"
...
notebook: FALSE
description: "本指南将帮助你在本地设置 Zilliz CLI 和 Agent 集成。设置完成后，你可以通过自然语言让 Agent 操作 Zilliz Cloud，也可以直接在终端、脚本和 CI 工作流中使用 CLI。 | BYOC"
type: origin
...
| **设置方式** | `/zilliz:quickstart` | `npx skills add zilliztech/zilliz-skill` | Install script + `zilliz login` |
| **自然语言** | 支持 | 支持 | 不支持 |
