...
beta: FALSE
notebook: FALSE
description: "本文列举了在 Zilliz Cloud 导入数据时可能遇到的常见问题及对应解决方法。 | CLOUD"
type: origin
...
1. 生成临时 Token。
    ...
    - 阿里云对象存储 OSS：[使用 STS 临时访问凭证访问 OSS](https://help.aliyun.com/zh/oss/developer-reference/use-temporary-access-credentials-provided-by-sts-to-access-oss)
