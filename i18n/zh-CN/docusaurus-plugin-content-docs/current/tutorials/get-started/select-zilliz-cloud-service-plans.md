...
notebook: FALSE
description: "Zilliz Cloud 提供多样的项目版本类型以满足不同的用户需求。不论是向量数据库领域的新手，还是追求可靠企业级解决方案的开发者，都需要根据性能、可扩展性及成本选择合适的版本类型。本文将提供不同版本间的对比，帮助您做出合适的选择。 | Cloud"
type: origin
...
Zilliz Cloud 提供多样的项目版本类型以满足不同的用户需求。不论是向量数据库领域的新手，还是追求可靠企业级解决方案的开发者，都需要根据性能、可扩展性及成本选择合适的版本类型。本文将提供不同版本间的对比，帮助您做出合适的选择。
...
<table>
   ...
   <tr>
     ...
     <td><p>弹性伸缩，无需配置</p></td>
     <td><p>最多 256 Query CU (支持的 Query CU 数量包括: 1, 2, 4, 6, 8, 12, 16, 20, 24, 28, 32,…,64, 72, 80, 88,…, 256</p><p>当 Query CU 大于 8 时，增加梯度为 4 CU。</p><p>当 Query CU 大于 64 时，增加梯度为 8 CU。)</p></td>
     <td><p>可根据用户需求定制</p></td>
   </tr>
   <tr>
     <td><p>弹性伸缩</p></td>
...
|  | **Free** | **Serverless** | **Dedicated 企业版** | **Bring Your Own Cloud (BYOC)** |
| --- | --- | --- | --- | --- |
| [细粒度的指标与实时监控面板](./view-cluster-metric-charts) |  | ✔ | ✔ | ✔ |
