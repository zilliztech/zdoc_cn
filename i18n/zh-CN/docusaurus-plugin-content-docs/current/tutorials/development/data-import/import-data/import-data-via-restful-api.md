...
您也可以调用RESTful API获取[当前导入任务的进度](https://docs.zilliz.com.cn/reference/restful/get-import-job-progress-v2)，并[列出所有导入任务](https://docs.zilliz.com.cn/reference/restful/list-import-jobs-v2)以获取更多信息。作为替代方案，您也可以前往Zilliz Cloud控制台上的[任务中心](./job-center)查看结果和作业详情。
