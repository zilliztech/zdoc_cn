...
在执行 BM25 Full Text Search 时，你可以对返回结果中的搜索词进行高亮显示，以帮助解释文档为何与查询匹配。有关 BM25 Full Text Search 的更多信息，请参阅 [Full Text Search](./full-text-search)。
...
创建 Highlighter 对象后，将其配置应用到 BM25 Full Text Search 请求中：
