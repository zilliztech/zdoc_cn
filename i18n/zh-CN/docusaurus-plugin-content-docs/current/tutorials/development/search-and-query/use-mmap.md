...
<table>
   <tr>
     ...
     <th rowspan="2"><p>Free 集群</p><p>Serverless 集群</p></th>
   </tr>
   <tr>
     <td><p>性能型 CU</p></td>
     <td><p>容量型 CU</p></td>
...
- 对于使用容量型 CU 的 Dedicated 集群而言，在加载 Collection 时，只有向量字段索引被默认加载到内存以保障 Collection 容量的最大化。修改默认设置可能会因 Collection 缩小而出现内存不足（OOM）问题。
