---
title: "使用 StructArray 进行 Grouping Search | Cloud"
...
notebook: FALSE
description: "本页介绍如何按父 Entity 对 StructArray Element-level Search 结果进行分组。当多个 Struct 元素匹配查询时，Element-level Search 可能从同一个 Entity 返回多个命中。Grouping 会折叠这些元素命中，使每个父 Entity 最多出现一次。 | Cloud"
type: origin
