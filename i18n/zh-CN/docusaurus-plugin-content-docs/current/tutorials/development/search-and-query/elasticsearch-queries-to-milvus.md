...
<table>
   ...
   <tr>
     ...
     <td rowspan="6"><p>当在 Elasticsearch 的过滤器上下文中使用左侧相关子句时，与 Zilliz Cloud 提供相同或相似的能力。</p></td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td><p>当在 Elasticsearch 的过滤器上下文中使用左侧相关子句时，与 Zilliz Cloud 提供相同或相似的能力。</p></td>
   </tr>
   <tr>
