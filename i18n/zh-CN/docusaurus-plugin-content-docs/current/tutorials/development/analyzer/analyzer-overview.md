...
在本示例中，我们定义了一个 Collection Schema，其中包含
...
验证 Analyzer 配置后，您可以参考以下示例将 Analyzer 添加到目标字段中。
...
您也可以使用 Zilliz Cloud 控制台完成上述配置。具体请参考以下演示。
...
配置 Analyzer 时，建议您参考以下文章，了解如何针对您的数据集选择合适的 Analyzer 配置。
