...
您还可以使用 Collection 的 **Partition** 选项卡来查找其子 Partition 中已加载实体的估计数量。此值通过使用 `get_partition_stats()` 获得。
...
- **为什么在 Collection 的“Partition”选项卡的“Entity 计数（近似）”列中显示的值在我插入或删除一些 Entity 后没有改变？**
