...
- **Admin**：集群 Admin 角色具备管理某个集群及其所有资源（Database、Collection）的权限。
    ...
    <table>
       ...
       <tr>
         ...
         <td><ul><li><p><a href="https://docs.zilliz.com.cn/reference/restful/collection-operations-v2">所有 Collection 操作</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/index-operations-v2">所有 Index 操作</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/partition-operations-v2">所有 Partition 操作</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/vector-operations-v2">所有 Vector 操作</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/alias-operations-v2">所有 Alias 操作</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/role-operations-v2">所有 Role 操作</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/user-operations-v2">所有 User 操作</a></p></li></ul></td>
       </tr>
    </table>
...
- **Read-Write**：集群 Read-Write 角色具备查看某个集群及管理其所有资源（Database、Collection）的权限。
    ...
    <table>
       ...
       <tr>
         ...
         <td><ul><li><p><a href="https://docs.zilliz.com.cn/reference/restful/collection-operations-v2">所有 Collection 操作</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/index-operations-v2">所有 Index 操作</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/partition-operations-v2">所有 Partition 操作</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/vector-operations-v2">所有 Vector 操作</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/alias-operations-v2">所有 Alias 操作</a></p></li></ul></td>
       </tr>
    </table>
...
- **Read-Only**：集群 Read-Only 角色具备查看某个集群及其所有资源（Database、Collection）的权限。
    ...
    <table>
       ...
       <tr>
         ...
         <td><ul><li><p>部分 Collection 操作</p><ul><li><p><a href="https://docs.zilliz.com.cn/reference/restful/describe-collection-v2">查看 Collection 详情</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/get-collection-load-state-v2">查看 Collection 加载状态</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/get-collection-stats-v2">查看 Collection 统计信息</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/has-collection-v2">查看 Collection 是否存在</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/list-collections-v2">查看 Collection 列表</a></p></li></ul></li><li><p>部分 Index 操作</p><ul><li><p><a href="https://docs.zilliz.com.cn/reference/restful/describe-index-v2">查看索引详情</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/list-indexes-v2">查看索引列表</a></p></li></ul></li><li><p>部分 Partition 操作</p><ul><li><p><a href="https://docs.zilliz.com.cn/reference/restful/get-partition-statistics-v2">查看 Partition 统计信息</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/has-partition-v2">查看 Partition 是否存在</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/list-partitions-v2">查看 Partition 列表</a></p></li></ul></li><li><p>部分 Alias 操作</p><ul><li><p><a href="https://docs.zilliz.com.cn/reference/restful/describe-alias-v2">查看 Alias 详情</a></p></li><li><p><a href="https://docs.zilliz.com.cn/reference/restful/list-aliases-v2">查看 Alias 列表</a></p></li></ul></li></ul></td>
       </tr>
    </table>
...
1. 配置角色的集群、Database、Collection 权限。选择权限组并选择目标资源。
    ...
    - Cluster 权限组: Admin (`Cluster_Admin`)、Read-Write (`Cluster_RW`)、Read-Only (`Cluster_RO`)

    有关权限和权限组的详细信息，请参考[权限](./cluster-privileges)。

    <Admonition type="info" icon="📘" title="说明">

    上述三个层级的内置权限组之间没有级联关系。设置集群层级的权限组并不会自动设置该集群下所有 Database 和 Collection 的权限，Database 和 Collection 层级的权限需要单独手动设置。
