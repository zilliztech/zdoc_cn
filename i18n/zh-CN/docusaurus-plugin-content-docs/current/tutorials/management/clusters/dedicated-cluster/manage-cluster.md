...
notebook: FALSE
description: "本文介绍了集群的生命周期，以便您充分利用 Zilliz Cloud 控制台来管理集群。 | Cloud"
type: origin
...
本文介绍了集群的生命周期，以便您充分利用 Zilliz Cloud 控制台来管理集群。
...
以下 Demo 以 Free 升级至 Dedicated 为例，展示如何升级集群部署方式。
