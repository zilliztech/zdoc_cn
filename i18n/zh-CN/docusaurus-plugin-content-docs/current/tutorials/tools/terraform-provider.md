...
[Zilliz Cloud Terraform Provider](https://registry.terraform.io/providers/zilliztech/zillizcloud/latest) 是一个开源 Infrastructure as Code (IaC) 方案，使你能够动态构建、更改和版本化 Zilliz Cloud 资源。使用前，你必须使用适当的凭据配置 provider，例如具有相应权限的 Zilliz Cloud API key。
