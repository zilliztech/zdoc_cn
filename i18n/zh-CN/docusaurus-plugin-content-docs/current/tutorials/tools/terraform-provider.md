...
- [扩展 Cluster](https://registry.terraform.io/providers/zilliztech/zillizcloud/latest/docs/guides/scale-cluster)
...
Zilliz Cloud 还提供 BYOC 方案，使组织能够将应用和数据托管在自己的云账号中，而不是依赖 Zilliz Cloud 的基础设施。BYOC 方案可部署为 BYOC 或 BYOC-I 模式，具体取决于你是否允许 Zilliz Cloud 通过跨账号权限代表你管理基础设施资源。详情请参阅 [BYOC 概览](/docs/byoc/byoc-intro)。
