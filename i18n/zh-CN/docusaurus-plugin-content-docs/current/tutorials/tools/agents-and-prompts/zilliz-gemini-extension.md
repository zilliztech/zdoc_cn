...
Zilliz Claude Code Plugin 和 Zilliz Gemini CLI Extension 底层都共享 Zilliz CLI。你可以阅读 Zilliz Claude Code Plugin 功能和 Zilliz Claude Code Plugin 示例来学习如何编写提示词。
