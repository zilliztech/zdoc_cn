...
````plaintext
  ...
  - 如果我提到全球集群，请说明：
    ...
    - 如果我直接连接全球集群中的特定 cluster，switchover 或 failover 后可能需要更新 endpoint
  ...
  ## 回答时：
    ...
    7. 如果这是全球集群，指出 routing behavior
    8. 指出常见连接错误
  ...
  - 这是 real-time serving cluster、on-demand cluster、全球集群，还是 private-endpoint setup？
  ...
  - 对全球集群，生产工作负载优先使用 `global endpoint`。
