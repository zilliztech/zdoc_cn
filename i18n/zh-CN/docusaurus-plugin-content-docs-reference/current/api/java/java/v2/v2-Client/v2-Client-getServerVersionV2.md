...
notebook: false
description: "此操作获取服务器版本信息。当除了版本字符串之外，还需要构建时间、Git commit、Go 版本和部署模式时，请使用 `detail(true)`。| Java | v2"
type: docx
...
此操作获取服务器版本信息。当除了版本字符串之外，还需要构建时间、Git commit、Go 版本和部署模式时，请使用 `detail(true)`。
