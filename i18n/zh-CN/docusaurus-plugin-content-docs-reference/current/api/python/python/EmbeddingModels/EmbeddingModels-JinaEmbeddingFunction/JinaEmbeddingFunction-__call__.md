...
notebook: false
description: "JinaEmbeddingFunction 中的此操作接受文本字符串列表，并将其直接编码为向量嵌入。 | Python"
type: docx
...
[JinaEmbeddingFunction](./EmbeddingModels-JinaEmbeddingFunction) 中的此操作接受文本字符串列表，并将其直接编码为向量嵌入。
