...
Zilliz Cloud 支持以下向量数据类型：`FLOAT_VECTOR` 为 [稠密向量](./use-dense-vector)，`SPARSE_FLOAT_VECTOR` 为 [稀疏向量](./use-sparse-vector)，以及 `BINARY_VECTOR` 为 [Binary 向量](./use-binary-vector)。
