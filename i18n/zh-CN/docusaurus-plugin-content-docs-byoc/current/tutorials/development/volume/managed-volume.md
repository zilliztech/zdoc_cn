...
本文将介绍如何通过 Web 控制台和 SDK 创建、管理和删除 Managed Volume。
...
- 每个组织最多可创建 **100 个 Managed Volume**。
...
从 Managed Volume 中删除数据可能需要几分钟，具体取决于文件或文件夹大小。
...
目前，您只能通过 Web 控制台从 Managed Volume 中删除数据。
