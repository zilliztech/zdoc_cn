...
如果您是组织管理员，只有在组织中还有其他管理员的情况下，您才可以离开组织。1 个组织必须拥有 1 名组织管理员。因此，如果您是组织中唯一一名管理员，您不可离开组织。
...
此外，Zilliz Cloud 还支持邀请用户加入项目。如果您是项目管理员，请点击左侧导航栏中的**项目成员**邀请用户加入项目。
