...
notebook: FALSE
description: "如果您手动删除集群，或集群因试用结束等原因被自动删除，其对应的数据备份会进入 Zilliz Cloud 回收站，并提供 30 天的宽限期，之后您可以使用这些备份数据恢复到新集群。 | BYOC"
type: origin
...
如果您手动删除集群，或集群因试用结束等原因被自动删除，其对应的数据备份会进入 Zilliz Cloud 回收站，并提供 30 天的宽限期，之后您可以使用这些备份数据恢复到新集群。
...
1. 点击**恢复**。Zilliz Cloud 将开始根据您在上一步骤中的配置创建新集群，并将您的数据恢复到集群中。
