...
notebook: FALSE
description: "默认情况下，组织用户可以从任意 IP 地址访问组织 Web 控制台。为限制访问并提升安全性，您可以为 Web 控制台配置 IP 白名单。配置后用户只能从指定的 IP 地址访问控制台，例如公司网络的 IP 地址。 | BYOC"
type: origin
...
控制台 IP 白名单仅针对组织 Web 控制台生效，不影响对项目集群的访问。
