module.exports = [
  {
    ...
    "items": [
      ...
      {
        "type": "doc",
        "id": "api/java/java/v2/v2-Authentication/v2-Authentication-createUser",
        "label": "createUser()",
        "key": "doc:api/java/java/v2/v2-Authentication/v2-authentication-createuser"
      },
      {
        "type": "doc",
      ...
      },
      {
        ...
        "key": "doc:api/java/java/v2/v2-Authentication/v2-authentication-updatepassword"
      },
      {
        "type": "doc",
        "id": "api/java/java/v2/v2-Authentication/v2-Authentication-alterRole",
        "label": "alterRole()",
        "key": "doc:api/java/java/v2/v2-Authentication/v2-authentication-alterrole"
      },
      {
        "type": "doc",
  ...
  },
  {
    ...
    "items": [
      {
        "type": "doc",
        "id": "api/java/java/v2/v2-Client/v2-Client-MilvusClientV2",
        "label": "MilvusClientV2",
        "key": "doc:api/java/java/v2/v2-Client/v2-client-milvusclientv2"
      },
      {
        "type": "doc",
    ...
    "items": [
      ...
      },
      {
        ...
        "items": [
          {
            "type": "doc",
            "id": "api/java/java/v2/v2-Collections/v2-Collections-CollectionSchema/v2-CollectionSchema-addField",
            "label": "addField()",
            "key": "doc:api/java/java/v2/v2-Collections/v2-Collections-CollectionSchema/v2-collectionschema-addfield"
          },
          {
            "type": "doc",
            "id": "api/java/java/v2/v2-Collections/v2-Collections-CollectionSchema/v2-Collections-CollectionSchema",
            "label": "CollectionSchema",
            "key": "doc:api/java/java/v2/v2-Collections/v2-Collections-CollectionSchema/v2-collections-collectionschema"
          },
          {
            "type": "doc",
            "id": "api/java/java/v2/v2-Collections/v2-Collections-CollectionSchema/v2-CollectionSchema-getField",
            "label": "getField()",
            "key": "doc:api/java/java/v2/v2-Collections/v2-Collections-CollectionSchema/v2-collectionschema-getfield"
          },
          {
            "type": "doc",
      ...
      {
        "type": "doc",
        "id": "api/java/java/v2/v2-Collections/v2-Collections-ConsistencyLevel",
        "label": "ConsistencyLevel",
        "key": "doc:api/java/java/v2/v2-Collections/v2-collections-consistencylevel"
      },
      {
        "type": "doc",
    ...
    "items": [
      {
        ...
        "key": "doc:api/java/java/v2/v2-FileResources/v2-fileresources-addfileresource"
      },
      {
        "type": "doc",
        "id": "api/java/java/v2/v2-FileResources/v2-FileResources-listFileResources",
        "label": "listFileResources()",
        "key": "doc:api/java/java/v2/v2-FileResources/v2-fileresources-listfileresources"
      },
      {
        "type": "doc",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "key": "doc:api/java/java/v2/v2-Management/v2-management-getrefreshexternalcollectionprogress"
      },
      {
        "type": "doc",
        "id": "api/java/java/v2/v2-Management/v2-Management-listRefreshExternalCollectionJobs",
        "label": "listRefreshExternalCollectionJobs()",
        "key": "doc:api/java/java/v2/v2-Management/v2-management-listrefreshexternalcollectionjobs"
      },
      {
        "type": "doc",
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "type": "doc",
        "id": "api/java/java/v2/v2-Vector/v2-Vector-hybridSearch",
        "label": "hybridSearch()",
        "key": "doc:api/java/java/v2/v2-Vector/v2-vector-hybridsearch"
      },
      {
        "type": "doc",
      ...
      {
        "type": "doc",
        "id": "api/java/java/v2/v2-Vector/v2-Vector-runAnalyzer",
        "label": "runAnalyzer()",
        "key": "doc:api/java/java/v2/v2-Vector/v2-vector-runanalyzer"
      },
      {
        "type": "doc",
