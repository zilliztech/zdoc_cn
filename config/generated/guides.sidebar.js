    ...
    "items": [
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "type": "doc",
            "id": "tutorials/get-started/cn-recvmzwqlreobp/quick-start-to-on-demand-search",
            "label": "快速开始：按需搜索",
            "key": "doc:tutorials/get-started/cn-recvmzwqlreobp/quick-start-to-on-demand-search"
          },
          {
            "type": "doc",
            "id": "tutorials/get-started/cn-recvmzwqlreobp/quick-start-to-external-data-lake-search",
            "label": "快速开始：External Data Lake Search",
            "key": "doc:tutorials/get-started/cn-recvmzwqlreobp/quick-start-to-external-data-lake-search"
          }
        ]
      },
      {
        ...
        "items": [
          ...
          },
          {
            ...
            "items": [
              ...
              {
                "type": "doc",
                "id": "tutorials/development/collection/manage-collection-on-console/manage-external-collections-console",
                "label": "管理 External Collection",
                "key": "doc:tutorials/development/collection/manage-collection-on-console/manage-external-collections-console"
              }
            ]
          },
          {
        ...
        "items": [
          ...
          },
          {
            ...
            "items": [
              {
                "type": "doc",
                "id": "tutorials/development/function/text-embedding-functions/siliconflow",
                "label": "硅基流动",
                "key": "doc:tutorials/development/function/text-embedding-functions/siliconflow"
              }
            ]
          },
          {
        ...
        "items": [
          ...
          },
          {
            ...
            "items": [
              {
                "type": "doc",
                "id": "tutorials/management/clusters/cn-recvmsesappzh6/on-demand-cluster",
                "label": "创建按需集群",
                "key": "doc:tutorials/management/clusters/cn-recvmsesappzh6/on-demand-cluster"
              },
              {
                "type": "doc",
                "id": "tutorials/development/connect-for-on-demand-search",
                "label": "连接按需搜索",
                "key": "ref:tutorials/management/clusters/cn-recvmsesappzh6/connect-for-on-demand-search"
              },
              {
                "type": "doc",
                "id": "tutorials/management/clusters/cn-recvmsesappzh6/manage-on-demand-clusters",
                "label": "Manage On-Demand Cluster",
                "key": "doc:tutorials/management/clusters/cn-recvmsesappzh6/manage-on-demand-clusters"
              },
              {
                "type": "doc",
                "id": "tutorials/development/database/on-demand-database",
                "label": "按需计算中的 Database",
                "key": "ref:tutorials/management/clusters/cn-recvmsesappzh6/on-demand-database"
              }
            ]
          },
          {
            ...
            "items": [
              {
                ...
                "id": "tutorials/development/volume/storage-integration/integrate-with-amazon-s3-cn",
                "label": "Amazon S3",
                "key": "ref:tutorials/management/volume/cn-recvmsfhfdsfky/integrate-with-amazon-s3-cn"
              },
              {
                "type": "doc",
                "id": "tutorials/development/volume/storage-integration/integrate-with-alibaba-cloud-oss",
                "label": "阿里云对象存储",
                "key": "ref:tutorials/management/volume/cn-recvmsfhfdsfky/integrate-with-alibaba-cloud-oss"
              }
            ]
          }
        ]
        ...
        "items": [
          {
            ...
            "items": [
              {
                "type": "doc",
                "id": "tutorials/management/cn-recvmseit6ebvl/migrate-from-milvus/via-endpoint",
                "label": "通过 Endpoint 从 Milvus 迁移至 Zilliz Cloud",
                "key": "doc:tutorials/management/cn-recvmseit6ebvl/migrate-from-milvus/via-endpoint"
              },
              {
                "type": "doc",
              ...
              {
                "type": "doc",
                "id": "tutorials/management/cn-recvmseit6ebvl/migrate-from-milvus/via-stage",
                "label": "通过备份工具从 Milvus 迁移至 Zilliz Cloud",
                "key": "doc:tutorials/management/cn-recvmseit6ebvl/migrate-from-milvus/via-stage"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "type": "doc",
                "id": "tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/external-migration-basics",
                "label": "外部迁移概述",
                "key": "doc:tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/external-migration-basics"
              },
              {
                "type": "doc",
                "id": "tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-pinecone",
                "label": "从 Pinecone 迁移至 Zilliz Cloud",
                "key": "doc:tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-pinecone"
              },
              {
                "type": "doc",
                "id": "tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-qdrant",
                "label": "从 Qdrant 迁移至 Zilliz Cloud",
                "key": "doc:tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-qdrant"
              },
              {
                "type": "doc",
                "id": "tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-elasticsearch",
                "label": "从 Elasticsearch 迁移至 Zilliz Cloud",
                "key": "doc:tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-elasticsearch"
              },
              {
                "type": "doc",
                "id": "tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-pgvector",
                "label": "从 PostgreSQL 迁移至 Zilliz Cloud",
                "key": "doc:tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-pgvector"
              },
              {
                "type": "doc",
                "id": "tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-tencent-cloud",
                "label": "从腾讯云向量数据库迁移至 Zilliz Cloud",
                "key": "doc:tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-tencent-cloud"
              },
              {
                "type": "doc",
                "id": "tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-opensearch",
                "label": "从 OpenSearch 迁移至 Zilliz Cloud",
                "key": "doc:tutorials/management/cn-recvmseit6ebvl/cn-recvmsfop1ewwx/migrate-from-opensearch"
              },
              {
                "type": "doc",
        ...
        "items": [
          {
            ...
            "id": "tutorials/development/function/text-embedding-functions/siliconflow",
            "label": "硅基流动",
            "key": "ref:tutorials/ai-models/cn-recvnetxkjza9x/siliconflow"
          }
        ]
      },
      {
        ...
        "items": [
          {
            ...
            "id": "tutorials/development/function/reranking-functions/model-based-rerankers/siliconflow-model-ranker",
            "label": "硅基流动 Ranker",
            "key": "ref:tutorials/ai-models/cn-recvneu7dixgyz/siliconflow-model-ranker"
          }
        ]
      }
    ]
