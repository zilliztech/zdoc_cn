...
- 访问控制
    通过 [API 密钥](./manage-api-keys)或[用户名密码身份验证](./manage-cluster-credentials)安全地访问专用集群和无服务器实例。
...
- RBAC 新角色
    授予[项目成员角色](./a-panorama-view)给项目协作者，以更流畅的协作。
...
- 自助服务账户删除
    轻松删除您自己的[账户](./delete-your-account#delete-your-account)或[组织](./delete-your-org)，更好地控制您的个人资料。
