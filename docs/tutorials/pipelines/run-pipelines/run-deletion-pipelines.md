...
1. 点击 Deletion Pipeline 右侧的 "▶︎" 按钮。 或者您可以点击**运行 Pipeline **选项卡。
...
以下示例代码用于运行 Deletion Pipeline `my_doc_deletion_pipeline`。该 Pipeline 的 `pipelineId` 是 `pipe-7227d0729d73e63002ed46`。
