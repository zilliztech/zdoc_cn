---
title: "使用 StructArray 进行 Hybrid Search | Cloud"
...
notebook: FALSE
description: "本页介绍如何在一个 Hybrid Search 请求中将 StructArray 向量搜索与其他向量搜索结合使用。StructArray Hybrid Search 可以生成 Entity-level 结果，也可以生成 Element-level 结果，具体取决于组合的 `AnnSearchRequest` 对象。 | Cloud"
type: origin
