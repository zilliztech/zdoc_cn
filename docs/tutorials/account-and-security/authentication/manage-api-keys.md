...
|  特性                |  API 密钥                                     |  用户名和密码对                                                                     |
| ------------------ | ------------------------------------------- | ---------------------------------------------------------------------------- |
|  使用范围              |  - 项目级别资源<br/> <br/>  - 管理项目中的所有集群和关联资源<br/>   |  - 集群级别资源<br/> <br/>  - 管理集群中的 Collection 和关联资源。<br/>                           |
|  认证                |  用于验证 RESTful API 或 SDK 调用                  |  用于验证 RESTful API 或 SDK 调用                                                   |
|  易用性               |  - 用户友好，学习曲线较低<br/> <br/>  - 无需管理 SDK 版本<br/>  |  - 适用于集群高级特性，如 RBAC 权限管理等<br/> <br/>  - 需要管理 SDK 版本<br/>                        |
|  创建方式              |  在项目页面上创建 API 密钥                            |  在集群管理页面上添加集群用户                                                              |
|  Collection / 资源管理 |  - 创建、删除 Collection<br/> <br/>  - 管理索引<br/>    |  - 创建、删除 Collection<br/> <br/>  - 管理索引<br/> <br/>  - 适用于 Collection 相关的高级特性<br/>  |
