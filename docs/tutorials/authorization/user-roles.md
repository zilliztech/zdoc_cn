...
<table>
   ...
   <tr>
     <td><p>组织管理员</p></td>
     <td><p>提供对整个组织内的全面访问权限：</p><ul><li><p>完全访问组织内的所有项目；</p></li><li><p>完全访问<a href="./payment-billing">支付与账单</a>相关信息；</p></li><li><p>管理 <a href="./manage-api-keys">API 密钥</a>；</p></li><li><p>管理<a href="./organization-users">组织成员</a>；</p></li><li><p>完全访问<a href="./metrics-and-alerts">指标与告警</a>；</p></li><li><p>查看<a href="./view-activities">事件</a>；</p></li><li><p>管理<a href="./organization-settings">组织设置</a>；</p></li><li><p>使用<a href="./use-recycle-bin">回收站</a>。</p></li></ul></td>
   ...
   <tr>
     <td><p>项目成员</p></td>
     <td><p>提供对项目内所有集群的读写权限：</p><ul><li><p>查看集群信息，但无法创建或管理集群；</p></li><li><p>管理 Collection 和 索引。</p></li></ul></td>
