...
- [JSON 索引](./use-json-fields)

- [JSON Shredding](./json-shredding)

- [向 Collection 添加字段](./add-fields-to-an-existing-collection)

- [Boost Ranker](./boost-ranker)

- [Decay Ranker](./decay-ranker-oveview)

- [INT8_VECTOR 数据类型](./use-number-field)

- [NGRAM 索引](./ngram-index-type)

- [MINHASH_LSH 索引](https://milvus.io/docs/zh/minhash-lsh.md)

- [多语言 Analyzer](./multi-language-analyzers)

- [分层存储集群类型](./cu-types-explained)
