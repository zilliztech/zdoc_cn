...
## 注册账户{#registering-an-account-with-privacy-protection}{#registering-an-account-with-privacy-protection}
...
## 创建和运行集群{#starting-a-cluster-with-security}{#starting-a-cluster-with-security}
...
有关详细信息，请参见[管理身份凭证](./undefined)和[管理 API 密钥](./manage-api-keys)。
...
## 私网连接{#private-links}{#private-links}
...
## 数据存储和传输{#storing-and-transmitting-data-with-encryption}{#storing-and-transmitting-data-with-encryption}
...
## 备份和恢复{#backup-and-restoration}{#backup-and-restoration}
