...
- **未绑定有效支付方式**
    ...
    <table>
       ...
       <tr>
         ...
         <td><p>1</p></td>
         <td><p>未绑定有效支付方式，最多可免费试用一个 Serverless 或 Dedicated 集群。如需更多集群，请添加支付方式。</p></td>
       </tr>
    </table>
...
您可以将数据从其他供应商迁移到您的 Zilliz Cloud 集群，每次迁移的最大集合数量会因您的 Zilliz Cloud 集群订阅计划而异。

<table>
   <tr>
     <th><p>目标集群订阅计划</p></th>
     <th><p>每次迁移支持的最大 Collection 数量</p></th>
   </tr>
   <tr>
     <td><p>Free</p></td>
     <td><p>5</p></td>
