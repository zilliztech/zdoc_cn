...
1. 单击刚才创建的私有域记录**操作**列中的**解析**，并在解析记录列表中添加解析记录。
    ...
    |  参数名称 |  参数说明                                                                                                                                                                                                                                 |
    | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    |  主机记录 |  您的 Zilliz Cloud 腾讯云集群的私网连接域名前缀。<br/> 如果您的集群 ID 为 **in01-xxxxxxxxxxx**，云地域 ID 为 **tc-ap-xxxxxxx**，则该域名前缀为 **in01-xxxxxxxxxxx-privatelink.tc-ap-xxxxxxx**。例如：<br/> - **in01-xxxxxxxxxxx-privatelink.tc-ap-beijing **(北京)<br/> |
