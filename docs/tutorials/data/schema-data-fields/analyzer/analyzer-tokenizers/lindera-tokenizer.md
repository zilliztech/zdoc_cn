...
<p><strong>中文用户</strong>：虽然 <code>lindera</code> 通过 <code>cc-cedict</code> 词典支持中文，但我们推荐使用 <code>[jieba](jieba-tokenizer.md)</code> 分词器。<a href="./jieba-tokenizer">Jieba</a> 专为中文分词设计，能提供更好的效果。</p>
