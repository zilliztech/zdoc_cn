...
在[组织和项目](./a-panorama-view)的层次结构中，您可以通过以下操作来管理您的项目与成员：

- [创建项目](./manage-projects-and-collaborator#create-a-project)

- [重命名项目](./manage-projects-and-collaborator#rename-a-project)

- [删除项目](./manage-projects-and-collaborator#delete-a-project)

- [邀请用户加入项目](./manage-projects-and-collaborator#invite-a-user-to-join-a-project)

- [撤销或重发邀请](./manage-projects-and-collaborator#revoke-or-resend-an-invitation)

- [编辑成员角色或移出成员](./manage-projects-and-collaborator#edit-a-collaborators-role-or-remove-a-collaborator)
...
当您创建项目时，您也会成为该项目的[项目管理员](./a-panorama-view#project-roles)。
...
要编辑成员角色或移出项目成员，你必须是[组织管理员](./a-panorama-view#organization-roles)或[项目管理员](./a-panorama-view#project-roles)。
