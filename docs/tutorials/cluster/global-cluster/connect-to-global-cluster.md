...
<p>建议在生产环境中使用全球 Endpoint。它无需在优雅切换或强切期间在应用代码中处理 Endpoint 变更。</p>
...
1. 在**连接**卡片中，复制全球 Endpoint 或公共 Endpoint。
    ...
    ![Z38HbClxuoAHA1xtG7yc1gAmnee](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/Z38HbClxuoAHA1xtG7yc1gAmnee.png)
...
<p>使用公共 Endpoint 时，仅主集群的公共 Endpoint 接受写入操作。向从集群的公共 Endpoint 写入将会失败。</p>
