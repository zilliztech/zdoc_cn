...
<table>
    ...
    <tr>
        <td><p>目标 Replica 数量</p></td>
        <td><p>系统计划将集群扩缩容至的新 Replica 数量</p></td>
    </tr>
    <tr>
        <td><p>当前 Replica 数量</p></td>
        <td><p>集群当前的 Replica 数量</p></td>
    </tr>
    <tr>
        <td><p>当前指标值</p></td>
        <td><p>当前测得的 CU 计算资源指标值</p></td>
    </tr>
    <tr>
        <td><p>目标指标值</p></td>
        <td><p>扩缩容后期望达到的 CU 计算资源值，固定为 50</p></td>
    </tr>
</table>
