...
## 挂起集群 | Dedicated {#suspend-cluster}
...
<table>
   ...
   <tr>
     ...
     <td><p>系统将创建一个新的 Dedicated 集群，并自动迁移您现有 Free 集群中的数据。原有的 Free 集群将被保留。 请务必在应用程序代码中更新集群的 Endpoint 信息。</p></td>
   </tr>
   <tr>
     <td><p>Serverless 升级至 Dedicated</p></td>
     <td><p>系统将创建一个新的 Dedicated 集群，并自动迁移您现有 Serverless 集群中的数据。原有的 Serverless 集群将被保留。 请务必在应用程序代码中更新集群的 Endpoint 信息。</p></td>
   </tr>
</table>
...
- **Free 升级至 Serverless**
    ...
    <Supademo id="cm9uspywg02s9wbbic92lh4ft" title="Zilliz Cloud - 升级版本 Demo (Free 至 Serverless）" />

- **Free 升级至 Dedicated**

    <Supademo id="cm9usub8202stwbbisrrk6yz0" title="Zilliz Cloud - 升级版本 Demo (Free 至 Dedicated）" />

- **Serverless 升级至 Dedicated**

    <Supademo id="cm9usblxp02q9wbbib30zsy3i" title="Zilliz Cloud - 升级版本 Demo (Serverless 至 Dedicated）" />

## 升级集群兼容版本以试用公测版功能 | Dedicated{#upgrade-cluster-for-preview-features}
