...
<table>
   ...
   <tr>
     ...
     <td><ul><li><p>阿里云、腾讯云： 1 年 - 7 折3年 - 5 折</p></li><li><p>亚马逊云科技：</p><p>1 年- 9 折</p></li></ul></td>
     <td><p>无折扣</p></td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td><p>不支持</p></td>
     <td><p>不支持 您可以先创建包年包月集群，随后将按量计费集群迁移到新创建的包年包月集群。详情请参考<a href="./migrate-between-clusters">Zilliz Cloud 跨集群迁移</a>。</p><p>迁移完成后，请将您应用中用于连接集群 Endpoint 变更为新集群的 Endpoint。</p></td>
   </tr>
   <tr>
