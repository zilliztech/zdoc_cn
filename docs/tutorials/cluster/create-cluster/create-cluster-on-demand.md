...
1. 在**创建新集群**页面，选择 **Dedicated 版**并配置相关参数。
    ...
    <table>
       ...
       <tr>
         ...
         <td><p>集群类型及 Query CU 数量。</p><p>界面上有关于集群类型的简要介绍，并提供了<a href="https://zilliz.com/pricing#calculator">计算器</a>供您自助估算成本。</p><p>想了解更多关于集群类型的相关内容，可参见<a href="./cu-types-explained">选择合适的 CU 类型</a>。</p><p>如需选择分层存储型 CU，集群规格需至少为 8 CU。</p></td>
       </tr>
       <tr>
