...
- **根据事件类型筛选**
    ...
    |  **事件类型** |  **描述**                                                                          |
    | --------- | -------------------------------------------------------------------------------- |
    |  信息       |  集群、权限、账单等相关信息。<br/> <br/>  例如：集群 in01-xxxxxxxxxxxxxxx 已创建。                        |
    |  警告       |  资源状态更新等需要留意的信息。<br/> <br/>  例如：集群 in01-xxxxxxxxxxxxxxx 已删除。                       |
    |  错误       |  账单支付失败或系统出错等需要立刻注意或采取行动的信息。<br/> <br/>  例如：账单 invo-xxxxxxxxxxxxxxxxxxxxxxxx 支付失败。 |
