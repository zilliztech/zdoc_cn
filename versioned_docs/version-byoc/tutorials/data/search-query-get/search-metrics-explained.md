...
![VFZmbd0ocoNWEXx5zuPcARp3nCe](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/VFZmbd0ocoNWEXx5zuPcARp3nCe.png)
...
![ZD5Xb8p7Bo5YnixQJXDcw4qUnHb](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/ZD5Xb8p7Bo5YnixQJXDcw4qUnHb.png)
...
![SUBObZ3AaoD8K7xDKr6c7E8gn6C](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/SUBObZ3AaoD8K7xDKr6c7E8gn6C.png)

两个 Embedding 向量间的关联度如下所示：

![XrIgbDui7oSh1gx3PdXcyrMqnUd](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/XrIgbDui7oSh1gx3PdXcyrMqnUd.png)
...
![KFqibEhgHoKnmjx8zj1cbfkZnEe](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/KFqibEhgHoKnmjx8zj1cbfkZnEe.png)
...
![KwyQbXF4no7W5wxHfIhc5Unlnug](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/KwyQbXF4no7W5wxHfIhc5Unlnug.png)

JACCARD 距离用于衡量数据集之间的不相似度，其计算方法是 1 减去 JACCARD 相似系数。对于二进制变量，JACCARD 距离等同于 Tanimoto 系数。

![JBpjbM06GoWfI4xDdVxcHpXsnHb](https://zdoc-images.oss-cn-hangzhou.aliyuncs.com/JBpjbM06GoWfI4xDdVxcHpXsnHb.png)
