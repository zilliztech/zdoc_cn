...
function validManifest(overrides = {}) {
  return {
    ...
    copy: [
      ...
      { from: 'scripts/docs-workflow/render-guides-table.js', to: 'scripts/docs-workflow/render-guides-table.js' },
      { from: 'scripts/docs-workflow/restore-guides-table-artifacts.js', to: 'scripts/docs-workflow/restore-guides-table-artifacts.js' },
...
test('accepts the declared CN overlay entries', () => {
  ...
  assert.deepEqual(manifest.copy.map((entry) => entry.to), [
    ...
    'scripts/docs-workflow/restore-guides-table-artifacts.js',
