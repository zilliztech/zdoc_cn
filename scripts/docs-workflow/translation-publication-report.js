...
const VALIDATION_SPECS = Object.freeze([
  ...
  Object.freeze({ id: 'ja-saas-mdx', command: 'npx docusaurus mdx-parse -d i18n/zh-CN/docusaurus-plugin-content-docs/current', executable: 'npx', args: Object.freeze(['docusaurus', 'mdx-parse', '-d', 'i18n/zh-CN/docusaurus-plugin-content-docs/current']) }),
  Object.freeze({ id: 'ja-byoc-mdx', command: 'npx docusaurus mdx-parse -d i18n/zh-CN/docusaurus-plugin-content-docs-byoc/current', executable: 'npx', args: Object.freeze(['docusaurus', 'mdx-parse', '-d', 'i18n/zh-CN/docusaurus-plugin-content-docs-byoc/current']) }),
